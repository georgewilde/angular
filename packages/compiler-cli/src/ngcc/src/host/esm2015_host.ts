...
import { ClassMember, ClassMemberKind, Declaration, Decorator, Import, Parameter } from '../../../ngtsc/host';
import { getImportOfSymbol, reflectObjectLiteral, TypeScriptReflectionHost } from '../../../ngtsc/metadata/src/reflector';
