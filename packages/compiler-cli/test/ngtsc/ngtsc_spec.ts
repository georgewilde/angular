...
describe('ngtsc behavioral tests', () => {
  ...
  it('should compile Components without errors', () => {
    ...
    const dtsContents = getContents('test.d.ts');
    expect(dtsContents).toContain('static ngComponentDef: ɵ0.ɵComponentDef<TestCmp, \'test-cmp\'>');
  });
  ...
  it('should compile NgModules without errors', () => {
    ...
    expect(dtsContents).toContain('static ngComponentDef: ɵ0.ɵComponentDef<TestCmp, \'test-cmp\'>');
    expect(dtsContents)
        .toContain('static ngModuleDef: ɵ0.ɵNgModuleDef<TestModule, [TestCmp], [], []>');
  ...
  it('should compile NgModules with services without errors', () => {
    ...
    const dtsContents = getContents('test.d.ts');
    expect(dtsContents)
        .toContain('static ngModuleDef: ɵ0.ɵNgModuleDef<TestModule, [TestCmp], [OtherModule], []>');
    expect(dtsContents).toContain('static ngInjectorDef: ɵ0.ɵInjectorDef');
  });
  ...
  it('should include @Pipes in @NgModule scopes', () => {
    ...
    const dtsContents = getContents('test.d.ts');
    expect(dtsContents).toContain('ɵ0.ɵNgModuleDef<TestModule, [TestPipe,TestCmp], [], []>');
  });
});
